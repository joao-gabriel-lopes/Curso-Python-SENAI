...
if (idade >= 18 and experiencia >= 2 and formacao == "sim"):
    print(f"Candidato {nome}, você foi aprovado, prossiga para o RH para mais instruções")
else:
    print(f"Candidato {nome}, você não possui as exigências necessárias, tenha um bom dia")